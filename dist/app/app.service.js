...
const scheduling_sys_1 = require("../scheduling-sys");
exports.app = express();
...
exports.app.use("/api/v1/hptype", hptype_routes_1.default);
...
exports.app.use("/api/v1/schedule", scheduling_sys_1.ScheduleRouter);
