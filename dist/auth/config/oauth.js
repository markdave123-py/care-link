...
exports.googleHp = exports.googlePatient = void 0;
const dotenv_1 = require("dotenv");
(0, dotenv_1.config)({ path: `.env.${process.env.NODE_ENV || 'development'}.local` });
const { GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, GOOGLE_HP_REDIRECT_URI, GOOGLE_PATIENT_REDIRECT_URI, GOOGLE_SCOPE, GOOGLE_AUTHORIZATION_URL, GOOGLE_TOKEN_ENDPOINT, GOOGLE_USERINFO } = process.env;
