...
hpRouter.post('/register', core_1.RequestValidator.validate(validation_1.registerHpSchema), hp_controller_1.default.register);
...
hpRouter.post('/logout', auth_middleware_1.default.authenticateUser, auth_controller_1.default.logout);
