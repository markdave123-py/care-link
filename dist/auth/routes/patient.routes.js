...
patientRouter.post('/refresh-access-token', auth_middleware_1.default.authenticateUser, patient_controller_1.default.refreshAccessToken);
...
patientRouter.post('/reset-password', patient_controller_1.default.resetPassword);
