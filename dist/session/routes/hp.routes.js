...
exports.HpSessRouter.patch("/end-session", controllers_1.HpSession.endSession);
exports.HpSessRouter.patch("/:request_session_id/accept-request", controllers_1.HpSession.acceptRequest);
exports.HpSessRouter.patch("/:decline-request", controllers_1.HpSession.declineRequest);
exports.HpSessRouter.patch("/:sessionId/update-sesssion", controllers_1.HpSession.updateSessionDetails);
