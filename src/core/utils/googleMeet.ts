...
//   const health_practitioner = await HealthPractitioner.findByPk(hp_id);
//   if (!health_practitioner) {
//     throw new Error("Health practitioner not found");
//   }
//   const refresh_token = health_practitioner.refresh_token;
//   oauth2Client.setCredentials({
